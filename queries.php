<?php
echo("<html><head><title>Three Queries</title></head>\n");

$hostname = 'dbdev.cs.uiowa.edu';
$username = 'changzhan';
$password = '';
$db_name = 'db_changzhan';
 ...
 * Query 1: For repeat customers, what is their average trip distance, trip price, and tip amount?
 * 
...
echo("<p style='color:red;'>Query 1: For repeat customers, what is there average trip distance, trip price, and tip amount? </p>");
echo("<p style='color:red;'>Query 2: Do drivers who maintain an average rating above a 3.0 receive greater average tips than those drivers with below a 3.0 average?
 </p>");
echo("<p style='color:red;'>Query 3: Which driver made the most money in the last three months, and how much was that? (sample data doesn't have enough of a timespan for the 3month part of this)
 </p>");
...
foreach ($sql_queries as $sql_query) {
     ...
     foreach ($headings[$iter++] as $heading) {
          echo("<th style='color:green;'>" . $heading . "</th>");
     }
     echo("</tr>");
